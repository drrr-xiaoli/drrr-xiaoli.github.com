...
【/搜索 关键字】
  ...
  按照关键字搜索歌曲，可以是歌手、歌曲名称，关键字需要连起来不允许有空格，如果有空格，直接忽略即可
### 音乐点播
【/播放 序号】

  根据搜索结果播放相应的歌曲。自动添加到歌单内。
### 查看歌单
【/歌单】

  查看当前播放列表，一般点歌后是自动添加到播放列表的。暂时自动播放后6分钟自动切歌。
### 清空歌单
【/清空歌单】

  新功能难免有bug，有时候点歌的时候歌单会卡住，无法正常播放。这个就是防止歌单出现bug的措施，可以通过清空歌单达到重置的效果。
## 一、用户系统指令
### 签到
【/签到】
